...
logit5 <- glm(Survived ~ Sex, data = titanic)
summary(logit5)
...
logit6 <- glm(Survived ~ Sex + Age, data = titanic)
summary(logit6)
...
logit7 <- glm(Survived ~ Sex + Pclass, data = titanic)
summary(logit7)
...
logit8 <- glm(Survived ~ Sex + pclass_factor, data = titanic)
summary(logit8)
...
logit9 <- glm(Survived ~ Sex + pclass_factor + Fare, data = titanic)
summary(logit9)
